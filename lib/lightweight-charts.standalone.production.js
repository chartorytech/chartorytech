...
!function() {
    ...
    function T(t, ...i) {
        for (const n of i)
            for (const i in n)
                void 0 !== n[i] && ("object" != typeof n[i] || void 0 === t[i] || Array.isArray(n[i]) ? t[i] = n[i] : T(t[i], n[i]));
        return t
    }
    function P(t) {
    ...
    class H {
        ...
        bt(t) {
            const i = this.F.wt();
            i.length !== this.ct.length && (this.dt = i.map(W),
        ...
        Mt() {
            ...
            i.forEach(( (i, e) => {
                ...
                h.rt = null !== (r = l.Bt) && void 0 !== r ? r : this.F.Vt(h.it[0].st / i.Dt().At()),
                h.it[0].ot = n,
                h.it[0].nt = s.zt(n),
                h.tt = j
            }
    ...
    function X(t, i, n, s, e, r, h=0, l=[0, 0, 0, 0], a="") {
        if (t.save(),
        !h || !a || a === r)
            return Z(t, i, n, s, e, l),
            t.fillStyle = r,
            t.fill(),
            void t.restore();
        const o = h / 2;
        var _;
        Z(t, i + o, n + o, s - h, e - h, (_ = -o,
        l.map((t => 0 === t ? t : t + _)))),
    ...
    class G {
        ...
        X(t, i, n, s) {
            if (!this.Et.yt || 0 === this.Et.Kt.length)
                return;
            const e = this.Et.O
              , r = this.Xt.t
    ...
    class Q extends J {
        ...
        Ei(t, i, n) {
            ...
            if (!s.labelVisible)
                return;
            const e = this.Ii.Ct();
            if (!this.jt.yt() || this.Ii.Ni() || null === e)
                return;
    ...
    class it {
        ...
        X(t, i) {
            ...
            Math.round(i.Wi.xi(t, f(this.Et).Kt, tt)))));
            if (n <= 0)
                return;
            const s = i.ji
              , e = n + 2 * s
    ...
    class rt extends st {
        ...
        Tn() {
            const t = this.$i.wt().map((t => t.zn().An())).filter(V)
              , i = 0 === t.length ? null : Math.max(...t);
            this.sn = null !== i ? i : NaN
        }
        Dn(t, i, n) {
            let s = t.get(i);
            return void 0 === s && (s = new Q(this,i,n),
            t.set(i, s)),
            s
        }
    }
    ...
    class St {
        bs(t, i) {
            ...
            if (void 0 === this.ys || void 0 === n || n.gs !== s || n.Ms !== e || n.xs !== r || n.Ss !== h || n.fs !== a || n.ks !== l) {
    ...
    class At {
        ...
        gt() {
            return this.Is.yt() ? (this.Fs(),
            null === this.Es ? null : this.Ws) : null
        }
        js() {
            this.zs = this.zs.map((t => Object.assign(Object.assign({}, t), this.Is.$s().Hs(t.ot))))
        }
        Us() {
            this.Es = null
        }
        ...
        Ys() {
            ...
            if (0 === this.Is.zn().Xs())
                return;
            const s = this.Is.Ct();
            null !== s && (this.Es = Vt(this.zs, n, this.Ns),
            this.Ks(t, i, s.Ot),
            this.Gs())
        }
    }
    ...
    class Zt extends N {
        ...
        Ue(t) {
            ...
            for (let t = this.Et.tt.from + 1; t < this.Et.tt.to; t++) {
                ...
                n.ot === s.ot + 1 && (n.Os - s.ui !== i + 1 && (s.Ye > s.Ze ? s.ui = n.Os - i - 1 : n.Os = s.ui + i + 1))
            }
    ...
    class ni {
        ...
        gt() {
            return this.Is.yt() ? (this.ft && (this.kr(),
            this.ft = !1),
            this.Sr) : null
        }
    }
    class si extends ni {
        ...
        kr() {
            ...
            if (2 !== i && 3 !== i)
                return;
            const n = this.Is.W();
            if (!n.baseLineVisible || !this.Is.yt())
                return;
            const s = this.Is.Ct();
            null !== s && (this.Mr.yt = !0,
        ...
        K({context: t, horizontalPixelRatio: i, verticalPixelRatio: n}, s, e) {
            if (null !== this.Et && null !== this.Et.tt) {
                ...
                for (let s = this.Et.tt.from; s < this.Et.tt.to; s++) {
                    ...
                    void 0 !== e.Kt && (e.Kt.Hi = this.lr.xi(t, e.Kt.th),
                    e.Kt.At = this.j,
    ...
    function bi(t, i, n, s) {
        i.fillStyle = t.O,
        void 0 !== t.Kt && function(t, i, n, s, e, r) {
            t.save(),
            t.scale(e, r),
            t.fillText(i, n, s),
            t.restore()
    ...
    function gi(t, i, n, s, e, r, h, l, a) {
        ...
        case "inBar":
            ...
            void (void 0 !== t.Kt && (t.Kt.st = t.st + f + r + .6 * e));
        case "aboveBar":
            return t.st = h.Rt(_, a) - f - s.nh,
            void 0 !== t.Kt && (t.Kt.st = t.st - f - .6 * e,
            s.nh += 1.2 * e),
            void (s.nh += d + r);
        case "belowBar":
            return t.st = h.Rt(u, a) + f + s.sh,
            void 0 !== t.Kt && (t.Kt.st = t.st + f + r + .6 * e,
            s.sh += 1.2 * e),
            void (s.sh += d + r)
        }
        i.position
    ...
    class Mi {
        ...
        oh() {
            ...
            for (let e = this.Et.tt.from; e < this.Et.tt.to; e++) {
                ...
                _.nt = i.zt(o.time),
                void 0 !== o.text && o.text.length > 0 && (_.Kt = {
                    th: o.text,
                    nt: 0,
                    st: 0,
                    Hi: 0,
    ...
    class xi extends ni {
        ...
        kr() {
            ...
            t.yt = !1;
            const i = this.Is.W();
            if (!i.priceLineVisible || !this.Is.yt())
                return;
    ...
    class Si extends J {
        ...
        Ei(t, i, n) {
            ...
            if (a.Zr)
                return;
            r && (t.Kt = this.bh(a, r, l),
            t.yt = 0 !== t.Kt.length),
            (h || l) && (i.Kt = this.wh(a, r, h, l),
            i.yt = i.Kt.length > 0);
            const o = s.ph(a.O)
              , _ = y(o);
            n.t = _.t,
    ...
    class yi {
        ...
        ts(t) {
            return null === t ? this : new yi(ki(Math.min, this.Th(), t.Th(), -1 / 0),ki(Math.max, this.Ph(), t.Ph(), 1 / 0))
        }
        Dh(t) {
            if (!P(t))
                return;
            if (0 === this.kh - this.Sh)
                return;
    ...
    class Ci {
        ...
        Bh() {
            return null === this.Ah ? null : {
                priceRange: this.Ah.Bh(),
    ...
    class Yi extends Di {
        constructor(t, i, n, s, e) {
            ...
            "Area" !== n && "Line" !== n && "Baseline" !== n || (this.Il = new ai(this)),
            this.$l(),
            this.Ul(e)
        }
        S() {
        ...
        $s() {
            return null !== this.Ll || (this.Ll = new Bi(this)),
            this.Ll
        }
        W() {
            return this.cn
        ...
        sa(t) {
            ...
            return this.zl.push(i),
            this.$t().Kl(this),
            i
        }
        ea(t) {
            const i = this.zl.indexOf(t);
            -1 !== i && this.zl.splice(i, 1),
            this.$t().Kl(this)
        }
        Jh() {
            return this.Hl
        ...
        Ul(t) {
            switch (this.dn = new Mi(this,this.$t()),
            this.Hl) {
            case "Bar":
    ...
    class Zi {
        ...
        Oa(t, i, n) {
            ...
            if (null === r)
                return s;
            const h = e.Rt(t, r)
              , l = n.Ba().filter((t => t instanceof Yi)).reduce(( (t, s) => {
                if (n.dr(s) || !s.yt())
                    return t;
                const e = s.Dt()
                  , r = s.zn();
    ...
    class on {
        ...
        Za(t, i, n) {
            ...
            Math.abs(l - a) < o))
                for (r = 0,
                h = this.Ya[0]; Mt(e, n * h, 1e-14) && e > s + 1e-14; )
                    e /= h,
    ...
    class _n {
        ...
        Za(t, i) {
            ...
            const n = this.Ii.At()
              ...
              , l = [];
            return l.push(e.Za(t, i, s), r.Za(t, i, s), h.Za(t, i, s)),
            function(t) {
                if (t.length < 1)
        ...
        Qa() {
            ...
            for (let n = a - u; n > o; n -= _) {
                ...
                null !== d && Math.abs(s - d) < this.Ja() || (s < h || s > l || (f < this.Xa.length ? (this.Xa[f].Ia = s,
                this.Xa[f].no = t.so(n)) : this.Xa.push({
                    Ia: s,
                    no: t.so(n)
                }),
                f++,
    ...
    class vn {
        ...
        Po(t) {
            ...
            void 0 !== t.yr && (this.cn.mode = t.yr,
            2 !== t.yr && 3 !== t.yr || (this.cn.autoScale = !0),
            this.ao.oo = !1),
            1 === i.yr && t.yr !== i.yr && (!function(t, i) {
                if (null === t)
                    return !1;
                const n = rn(t.Th(), i)
                  , s = rn(t.Ph(), i);
                return isFinite(n) && isFinite(s)
            }(this.Ah, this.Mo) ? this.cn.autoScale = !0 : (n = ln(this.Ah, this.Mo),
            null !== n && this.Vo(n))),
            1 === t.yr && t.yr !== i.yr && (n = hn(this.Ah, this.Mo),
            null !== n && this.Vo(n));
        ...
        Vo(t, i) {
            const n = this.Ah;
            (i || null === n && null !== t || null !== n && !n.yh(t)) && (this.mo = null,
            this.Ah = t)
        }
        Ni() {
            return this.Fo(),
            0 === this.ro || !this.Ah || this.Ah.Ni()
        }
        Wo(t) {
            return this.Bo() ? t : this.At() - 1 - t
        }
        Rt(t, i) {
            return this.gh() ? t = Qi(t, i) : this.Oo() && (t = nn(t, i)),
            this.To(t, i)
        }
        Qs(t, i, n) {
            this.Fo();
        ...
        ja() {
            ...
            if (null !== this.mo && (t || this.mo.Zo === t))
                return this.mo.ja;
            this.yo.Qa();
            const i = this.yo.ja();
            return this.mo = {
        ...
        Pa() {
            ...
            this.ba = fn,
            this.gh() ? (this.ba = dn,
            i = 100) : this.Oo() ? (this.ba = new _t(100,1),
        ...
        Lo() {
            return this.Bo() ? this.cn.scaleMargins.bottom * this.At() + this.co : this.cn.scaleMargins.top * this.At() + this.uo
        }
        No() {
            return this.Bo() ? this.cn.scaleMargins.top * this.At() + this.uo : this.cn.scaleMargins.bottom * this.At() + this.co
        }
        Fo() {
            ...
            null !== i) {
                ...
                if (this.eo()) {
                    ...
                    r.Ha !== h.Ha || r.$a !== h.$a) {
                        ...
                        this.Mo = n,
                        i = hn(t, n),
                        null !== s && (this.lo = hn(s, n))
                    }
                }
                this.Vo(i)
            } else
                null === this.Ah && (this.Vo(new yi(-.5,.5)),
                this.Mo = an(null));
            var r, h;
            this.ao.oo = !0
        }
        jo() {
            return this.gh() ? Qi : this.Oo() ? nn : this.eo() ? t => en(t, this.Mo) : null
        }
        l_(t, i, n) {
    ...
    class pn {
        ...
        $o() {
            return null === this.po && (this.po = un(this.vo)),
            this.po
        }
        F_() {
            return this.u_
    ...
    class Mn {
        ...
        hu() {
            return null === this.ru ? null : new bn(Math.floor(this.ru.Os()),Math.ceil(this.ru.ui()))
        }
        lu() {
            return this.ru
        }
    ...
    class Sn {
        ...
        $u(t) {
            ...
            return void 0 === i && (i = new mn((t => this.dc(t)),this.U_),
        ...
        od(t, i, n) {
            ...
            if (null !== h && null !== s && null !== e) {
                const i = h.Xr(r)
                  ...
                  , _ = i && (!(void 0 === n) || o) && this.kl.W().shiftVisibleRangeOnNewBar;
                if (a && !_) {
                    const i = t - r;
    ...
    function In(t, i, n) {
        return i.replace(/yyyy/g, (t => ot(En(t), 4))(t)).replace(/yy/g, (t => ot(En(t) % 100, 2))(t)).replace(/MMMM/g, ( (t, i) => new Date(t.getUTCFullYear(),t.getUTCMonth(),1).toLocaleString(i, {
            month: "long"
    ...
    class Nn {
        ...
        q_(t) {
            return this.Md.replace("%h", ot(t.getUTCHours(), 2)).replace("%m", ot(t.getUTCMinutes(), 2)).replace("%s", ot(t.getUTCSeconds(), 2))
        }
    }
    const Fn = {
        xd: "yyyy-MM-dd",
    ...
    function qn(t, i) {
        ...
        for (let n = $n.length - 1; n >= 0; --n)
            if (Math.floor(i.getTime() / $n[n].Rd) !== Math.floor(t.getTime() / $n[n].Rd))
                return $n[n].Dd;
        return 0
    }
    function Yn(t) {
    ...
    class Gn {
        ...
        createConverterToInternalObj(t) {
            return f(function(t) {
                return 0 === t.length ? null : An(t[0].time) || D(t[0].time) ? Yn : Zn
            }(t))
        }
        key(t) {
        ...
        updateFormatter(t) {
            ...
            this.cn.timeScale.timeVisible ? this.Vd = new Wn({
                xd: i,
    ...
    var is = function() {
        ...
        t.prototype._resizeBitmap = function(t) {
            ...
            Qn(i, t) || (this.canvasElement.width = t.width,
        ...
        t.prototype._suggestNewBitmapSize = function(t) {
            ...
            null === i && null === s || null !== i && null !== s && Qn(i, s) || (this._suggestedBitmapSize = s,
    ...
    class us {
        ...
        qd(t, i) {
            if (null !== this.Ed) {
                if (this.Ed.ot === i)
                    return void (this.Ed.zd = t);
                if (Math.abs(this.Ed.zd - t) < this.rs)
                    return
            }
            this.Nd = this.Ld,
            this.Ld = this.Id,
    ...
    class ws {
            ...
            this.zf = t => {
                if (this.Ef(t)) {
                    ...
                    this._f && this.af > 1) {
                        ...
                        n < 30 && !this.bf && this.Ff(i, this.jf.Wf),
                        this.Hf()
                    }
                } else {
                    const i = this.If(t);
                    ...
                    this.hf && this.rf > 1) {
                        ...
                        n < 5 && !this.mf && this.$f(i, this.jf.Uf),
                        this.qf()
                    }
                }
            }
        ...
        S() {
            ...
            this.wf = null),
            null !== this.gf && (this.gf(),
            this.gf = null),
            null !== this.xf && (this.xf(),
            this.xf = null),
            null !== this.Sf && (this.Sf(),
            this.Sf = null),
            null !== this.kf && (this.kf(),
            this.kf = null),
        ...
        av(t) {
            ...
            this.kf = null);
            const n = this.If(t, i);
            if (this.Ff(n, this.jf.ov),
            ++this.af,
            this._f && this.af > 1) {
                const {Lf: t} = this.Nf(xs(i), this.uf);
                t < 30 && !this.bf && this.Ff(n, this.jf.Wf),
                this.Hf()
            } else
                this.bf || (this.Ff(n, this.jf._v),
                this.jf._v && Ms(t));
            0 === this.af && Ms(t),
            0 === t.touches.length && this.df && (this.df = !1,
            Ms(t))
        }
        Af(t) {
            if (0 !== t.button)
            ...
            this.Sf = null),
            hs()) {
                this.Yf.ownerDocument.documentElement.removeEventListener("mouseleave", this.Vf)
            }
            if (!this.Ef(t))
                if (this.$f(i, this.jf.uv),
                ++this.rf,
                this.hf && this.rf > 1) {
                    const {Lf: n} = this.Nf(xs(t), this.lf);
                    n < 5 && !this.mf && this.$f(i, this.jf.Uf),
                    ...
                    this.mf || this.$f(i, this.jf.cv)
        }
        Xf() {
            null !== this.cf && (clearTimeout(this.cf),
            this.cf = null)
        }
        dv(t) {
            if (null !== this.Of)
        ...
        Zf() {
            ...
            this.Yf.addEventListener("touchcancel", this.Xf.bind(this));
            {
                const t = this.Yf.ownerDocument
                  , i = t => {
                    this.jf.bv && (t.composed && this.Yf.contains(t.composedPath()[0]) || t.target && this.Yf.contains(t.target) || this.jf.bv())
                }
                ;
                this.gf = () => {
        ...
        gv() {
            void 0 === this.jf.Mv && void 0 === this.jf.xv && void 0 === this.jf.Sv || (this.Yf.addEventListener("touchstart", (t => this.kv(t.touches)), {
                passive: !0
            }),
        ...
        Cv(t) {
            const i = this.Yf.getBoundingClientRect() || {
                left: 0,
                top: 0
            };
            this.yf = {
        ...
        yv() {
            null !== this.yf && (this.yf = null,
            void 0 !== this.jf.Sv && this.jf.Sv())
        }
        wv(t) {
            if (this.xf && this.xf(),
            this.Ef(t))
        ...
        Ef(t) {
            return t.sourceCapabilities && void 0 !== t.sourceCapabilities.firesTouchEvents ? t.sourceCapabilities.firesTouchEvents : Ss(t) < this.Df + 500
        }
        Ff(t, i) {
            i && i.call(this.jf, t)
        }
        ...
        If(t, i) {
            ...
            return {
                ...
                shiftKey: t.shiftKey,
                metaKey: t.metaKey,
                Rv: !t.type.startsWith("mouse") && "contextmenu" !== t.type && "click" !== t.type,
                Dv: t.type,
                Ov: n.target,
                Bv: t.view,
                Vv: () => {
    ...
    class Rs {
        ...
        ap() {
            ...
            const s = this.Ii.ja();
            n.font = this.op(),
            s.length > 0 && (t = Math.max(this.Nv.xi(n, s[0].no), this.Nv.xi(n, s[s.length - 1].no)));
            const e = this._p();
            ...
            if (null !== r && null !== this.Iv) {
                ...
                t = Math.max(t, this.Nv.xi(n, this.Ii.Fi(Math.floor(Math.min(i, s)) + .11111111111111, r)), this.Nv.xi(n, this.Ii.Fi(Math.ceil(Math.max(i, s)) - .11111111111111, r)))
            }
            n.restore();
            const h = t || 34;
        ...
        up(t) {
            null !== this.Iv && Qn(this.Iv, t) || (this.Iv = t,
            this.Wv = !0,
        ...
        Gi(t) {
            this.Ii !== t && (null !== this.Ii && this.Ii.Xo().p(this),
            this.Ii = t,
        ...
        sp(t) {
            if (null === this.Ii)
                return;
            !this.tn.Hv().$t().W().handleScale.axisPressedMouseMove.price || this.Ii.gh() || this.Ii.Oo() || this.Sp(1)
        }
        ep(t) {
            this.Sp(0)
        }
        ...
        Ae({context: t, bitmapSize: i, horizontalPixelRatio: n}) {
            ...
            let e;
            e = this.Uv ? i.width - s : 0,
            t.fillRect(e, 0, s, i.height)
        }
        bp(t) {
            if (null === this.Iv || null === this.Ii)
                return;
            const i = this.Ii.ja()
              , n = this.Ii.W()
              , s = this.lp()
        ...
        vp() {
            ...
            const t = []
              ...
              , n = this.tn.dp()
              , s = this.lp();
            this.Ii === n.vr() && this.tn.dp().$o().forEach((t => {
                n.dr(t) && i.push(t)
            }
            ));
            const e = this.Ii;
        ...
        kp(t, i) {
            ...
            for (const n of t) {
                const t = Math.floor(n.At(i) / 2)
                  , s = n.ki();
                s > -t && s < t && n.Bi(t),
                s > this.Iv.height - t && s < this.Iv.height + t && n.Bi(this.Iv.height - t)
            }
            Ps(s, 1, this.Iv.height, i),
            Ps(e, -1, this.Iv.height, i)
        }
        wp(t) {
            if (null === this.Iv)
                return;
    ...
    class As {
        ...
        Up(t) {
            ...
            null !== this.Lp && this.Lp.F_().p(this),
            this.Lp = t,
            null !== this.Lp && this.Lp.F_().l(As.prototype.Np.bind(this), this, !0),
            this.$p(),
            this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = null !== (i = this.Tp) && void 0 !== i ? i : new cs(this.Fp,this.Jd),
            this.Tp.bt()) : (null === (n = this.Tp) || void 0 === n || n.tf(),
            this.Tp = null)
        }
        Hv() {
            return this.Jd
        ...
        Zp() {
            null !== this.yp && this.yp.bt(),
            null !== this.Cp && this.Cp.bt()
        }
        g_() {
        ...
        Qf(t) {
            ...
            this.Kp(n, s, t);
            const e = this.br(n, s);
            this.Jd.Jp(null !== (i = null == e ? void 0 : e.Ev) && void 0 !== i ? i : null),
            this.$i().Wc(e && {
                jc: e.jc,
                Av: e.Av
            })
        ...
        xv(t, i) {
            if (!this.Jd.W().handleScale.pinch)
                return;
            const n = 5 * (i - this.Bp);
            this.Bp = i,
            this.$i().Jc(t.nt, n)
        ...
        vv(t) {
            this.Vp = !1,
            this.zp = null !== this.Ap,
            this.Gp();
            const i = this.$i().Yc();
            null !== this.Ap && i.yt() && (this.Ep = {
                x: i.Yt(),
                y: i.Zt()
            },
            this.Ap = {
        ...
        br(t, i) {
            ...
            return null === n ? null : function(t, i, n) {
                ...
                if ("top" === (null == e ? void 0 : e.zv.zOrder))
                    return ys(e);
                for (const r of s) {
                    if (e && e.jc === r && "bottom" !== e.zv.zOrder && !e.zv.isBackground)
                        return ys(e);
        ...
        om(t, i) {
            f("left" === i ? this.yp : this.Cp).up(Jn({
                width: t,
                height: this.Iv.height
            }))
        }
        _m() {
            return this.Iv
        ...
        Yp() {
            ...
            i || null === this.yp || (this.Wp.removeChild(this.yp.hp()),
            this.yp.S(),
            this.yp = null),
            n || null === this.Cp || (this.jp.removeChild(this.Cp.hp()),
            this.Cp.S(),
            this.Cp = null);
            const s = t.$t()._d();
            i && null === this.yp && (this.yp = new Rs(this,t.W(),s,"left"),
            this.Wp.appendChild(this.yp.hp())),
            n && null === this.Cp && (this.Cp = new Rs(this,t.W(),s,"right"),
        ...
        im(t) {
            ...
            const s = this.Jd.W()
              , e = s.handleScroll
              , r = s.kineticScroll;
            if ((!e.pressedMouseMove || t.Rv) && (!e.horzTouchDrag && !e.vertTouchDrag || !t.Rv))
                return;
            const h = this.Lp.vn()
              , l = performance.now();
            if (null !== this.Pp || this.Mm(t) || (this.Pp = {
                x: t.clientX,
                y: t.clientY,
                Od: l,
                km: t.localX,
            ...
            null !== this.Pp && !this.Rp && (this.Pp.x !== t.clientX || this.Pp.y !== t.clientY)) {
                if (t.Rv && r.touch || !t.Rv && r.mouse) {
                    const t = n.he();
                    this.Ip = new us(.2 / t,7 / t,.997,15 / t),
                    this.Ip.qd(n.ju(), this.Pp.Od)
                } else
                    this.Ip = null;
                h.Ni() || i.V_(this.Lp, h, t.localY),
                i.td(t.localX),
                this.Rp = !0
            }
            this.Rp && (h.Ni() || i.A_(this.Lp, h, t.localY),
            i.nd(t.localX),
    ...
    class zs {
        ...
        fp(t) {
            if (t < 3 && !this.ft)
                return;
            if (0 === this.Iv.width || 0 === this.Iv.height)
                return;
            this.ft = !1,
            this.Kv.applySuggestedBitmapSize();
            const i = es(this.Kv);
    ...
    class Fs {
        ...
        Nm(t, i, n) {
            ...
            this.Xv.style.height = `${t.height}px`,
            this.Om.m(t)),
            null !== this.Pm && this.Pm.up(Jn({
                width: i,
                height: t.height
            })),
            null !== this.Rm && this.Rm.up(Jn({
                width: n,
                height: t.height
            }))
        }
        ...
        Hm(t, i) {
            ...
            for (const s of n)
                ms(i, (i => vs(i, t, !1, void 0)), s, void 0);
            for (const s of n)
                ms(i, (i => ps(i, t, !1, void 0)), s, void 0)
        }
        pp({context: t, bitmapSize: i}) {
        ...
        bp(t) {
            ...
            t.useMediaCoordinateSpace(( ({context: t}) => {
                ...
                for (const e of n)
                    if (e.weight < s) {
                        const n = e.needAlignCoordinate ? this.qm(t, e.coord, e.label) : e.coord;
        ...
        qm(t, i, n) {
            const s = this.Nv.xi(t, n)
              , e = s / 2
              , r = Math.floor(i - e) + .5;
            return r < 0 ? i += Math.abs(0 - r) : r + s > this.Iv.width && (i -= Math.abs(this.Iv.width - (r + s))),
            i
        }
        $m(t, i) {
            const n = this.Wm();
        ...
        zm() {
            const t = this.Jd.$t()
              , i = t.W();
            i.leftPriceScale.visible || null === this.Pm || (this.Bm.removeChild(this.Pm.hp()),
            this.Pm.S(),
            this.Pm = null),
            i.rightPriceScale.visible || null === this.Rm || (this.Vm.removeChild(this.Rm.hp()),
            this.Rm.S(),
            this.Rm = null);
            const n = {
                _d: this.Jd.$t()._d()
              ...
              , e = () => t.md();
            i.leftPriceScale.visible && null === this.Pm && (this.Pm = new zs("left",i,n,s,e),
            this.Bm.appendChild(this.Pm.hp())),
            i.rightPriceScale.visible && null === this.Rm && (this.Rm = new zs("right",i,n,s,e),
            this.Vm.appendChild(this.Rm.hp()))
        }
    }
    const Ws = !!rs && !!navigator.userAgentData && navigator.userAgentData.brands.some((t => t.brand.includes("Chromium"))) && !!rs && ((null === (js = null === navigator || void 0 === navigator ? void 0 : navigator.userAgentData) || void 0 === js ? void 0 : js.platform) ? "Windows" === navigator.userAgentData.platform : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
    var js;
    class Hs {
        constructor(t, i, n) {
            var s;
        ...
        S() {
            ...
            this.Zm = [],
            f(this.lb).S(),
            null !== this.Zd.parentElement && this.Zd.parentElement.removeChild(this.Zd),
            this.Pc.S(),
            this.Dp.S(),
            this.Op.S(),
            this.fb()
        ...
        bb() {
            null !== this.Jm && (this.pb(this.Jm, performance.now()),
            this.Jm = null);
        ...
        Jp(t) {
            this.ib = t,
            this.ib ? this.kb().style.setProperty("cursor", t) : this.kb().style.removeProperty("cursor")
        }
        yb() {
            return this.ib
        }
        ...
        mb(t) {
            (void 0 !== t.autoSize || !this.tb || void 0 === t.width && void 0 === t.height) && (t.autoSize && !this.tb && this.ab(),
            !1 === t.autoSize && null !== this.tb && this.fb(),
            t.autoSize || void 0 === t.width && void 0 === t.height || this.ob(t.width || this.o_, t.height || this.ro))
        }
        wb(t) {
            let i = 0
              , n = 0;
        ...
        Tb() {
            ...
            for (const s of this.Zm)
                this.Mb() && (i = Math.max(i, f(s.bm()).ap(), this.cn.leftPriceScale.minimumWidth)),
                this.xb() && (n = Math.max(n, f(s.wm()).ap(), this.cn.rightPriceScale.minimumWidth)),
                t += s.g_();
            i = as(i),
            n = as(n);
            const s = this.o_
        ...
        pb(t, i) {
            ...
            3 === (null === (n = this.Jm) || void 0 === n ? void 0 : n.jn()) && (this.Jm.ts(t),
            this.Rb(),
            this.Db(this.Jm),
            this.Ob(this.Jm, i),
            t = this.Jm,
        ...
        fb() {
            null !== this.tb && this.tb.disconnect(),
            this.tb = null
        }
    }
    function $s(t) {
    ...
    function te(t, i) {
        return void 0 !== i.customValues && (t.Wb = i.customValues),
        t
    }
    function ie(t) {
    ...
    class he {
        ...
        Xb(t, i) {
            ...
            if (void 0 !== e)
                if (1 === this.qb.size)
                    ...
                    for (const i of this.Zb)
                        i.pointData.jb.delete(t) && (s = !0);
            let r = [];
            if (0 !== i.length) {
            ...
            return this.Qb(t, h, function(t, i, n) {
                const s = ee(t, n)
                  , e = ee(i, n);
                if (void 0 !== s && void 0 !== e)
                    return {
                        Ql: s.$b >= e.$b && s.Hb >= e.Hb
                    }
        ...
        tw(t, i) {
            ...
            for (let t = d; t < this.Zb.length; ++t)
                le(this.Zb[t].pointData, t);
            return this.U_.fillWeightsForPoints(this.Zb, d),
            this.Qb(t, d, u)
        }
        iw(t, i) {
            let n = this.qb.get(t);
            ...
            null === s || this.U_.key(i.ot) > this.U_.key(s.ot) ? Qs(i) && n.push(i) : Qs(i) ? n[n.length - 1] = i : n.splice(-1, 1),
            this.Yb.set(t, i.ot)
        }
        Gb(t, i) {
            0 !== i.length ? (this.qb.set(t, i.filter(Qs)),
            this.Yb.set(t, i[i.length - 1].ot)) : (this.qb.delete(t),
            this.Yb.delete(t))
        }
        Kb() {
        ...
        Jb(t) {
            ...
            if (-1 === i && this.Zb.length !== t.length && (i = Math.min(this.Zb.length, t.length)),
            -1 === i)
                return -1;
            for (let n = i; n < t.length; ++n)
                le(t[n].pointData, n);
    ...
    function ae(t) {
        ...
        return void 0 !== t.Wb && (i.customValues = t.Wb),
        i
    }
    function oe(t) {
        const i = ae(t);
    ...
    class Pe {
        ...
        barsInLogicalRange(t) {
            ...
            return null !== s && null !== e && (l.from = s.zb,
            l.to = e.zb),
            l
        }
        setData(t) {
            this.U_,
            this.Is.Jh(),
            this.uw.fw(this.Is, t),
            this.pw("full")
        }
        update(t) {
            this.Is.Jh(),
            this.uw.mw(this.Is, t),
            this.pw("update")
        }
        dataByIndex(t, i) {
        ...
        setMarkers(t) {
            this.U_;
            const i = t.map((t => ye(t, this.U_.convertHorzItemToInternal(t.time), t.time)));
            this.Is.ia(i)
        }
        markers() {
    ...
    function Oe(t) {
        return function(t) {
            if (O(t.handleScale)) {
                ...
                O(i) && (t.handleScale.axisPressedMouseMove = {
                    time: i,
                    price: i
                }),
                O(n) && (t.handleScale.axisDoubleClickReset = {
                    time: n,
                    price: n
                })
            }
